...
# %% auto 0
__all__ = ['obsidian_fldrs', 'prefix', 'get_obsidian_fldrs', 'EditComponent', 'mount_apps', 'get_nav_items', 'get_toolbar_items']
...
def get_toolbar_items():
    ...
    return { 
        MountPaths.open.get_app_url(): [EditComponent()]
            }
